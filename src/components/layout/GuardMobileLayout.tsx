...
const navigation = [
  { name: "Home", href: "/guard", icon: Home },
  { name: "Scan", href: "/guard/scan", icon: ScanLine },
  { name: "Patrol", href: "/guard/patrol", icon: Clock },
  { name: "Incidents", href: "/guard/incidents", icon: AlertTriangle },
  { name: "Profile", href: "/guard/profile", icon: User },
];

export function GuardMobileLayout({ children, title }: GuardMobileLayoutProps) {
